...
public class AlgorithmConfiguration {
    ...
    public static final double DEFAULT_PROBABILITY_TO_APPLY_DATA_REDUCTIONS = 1;
    ...
    private double probabilityToApplyDataReductions = DEFAULT_PROBABILITY_TO_APPLY_DATA_REDUCTIONS;
    ...
    public double getProbabilityToApplyDataReductions() {
        return probabilityToApplyDataReductions;
    }

    public void setProbabilityToApplyDataReductions(double probabilityToApplyDataReductions) {
        this.probabilityToApplyDataReductions = probabilityToApplyDataReductions;
    }
