...
# ./example_scenarios/smac-wce/wrapper.py example_scenarios/smac-wce/instances/3-actionseq/a065.dimacs "" 1 2147483647 1234
...
status = "TIMEOUT"
if (re.search('#recursive steps', stdout_)):
    status = 'SUCCESS'
